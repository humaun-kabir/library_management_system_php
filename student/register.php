            ...
            if($email_check_row == 0){
                ...
                if($username_check_row == 0){
                    if(strlen($username) > 7){
                        ...
                        $password_exists = "password must be 8 characters";
                        }
                    }else{
                    $username_exists = "usename must be 8 characters";
                    }
                }else{
                    $username_exists = "this usename already exists";
                }
            }else{
...
<div class="wrap">
    ...
    <div class="page-body animated slideInDown">
        ...
        <!--LOGO-->
        <div class="logo">
            <h1 class="text-center">Lib. Mg. Sys.</h1>
        </div>
        <div class="box">
            <!--SIGN IN FORM-->
